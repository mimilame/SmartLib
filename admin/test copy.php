<?php
	// test%20copy.php - Modern UI design with tab layout for system settings
...
<?php if ($message): ?>
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		if (window.history.replaceState) {
			window.history.replaceState(null, null, 'test%20copy.php?tab=<?= $active_tab ?>');
		}
	});
	</script>
<?php endif; ?>
            ...
            <ul class="nav nav-tabs card-header-tabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link <?= $active_tab === 'general' ? 'active bg-white text-primary' : 'text-white' ?>" 
                       href="test%20copy.php?tab=general" role="tab">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link <?= $active_tab === 'features' ? 'active bg-white text-primary' : 'text-white' ?>" 
                       href="test%20copy.php?tab=features" role="tab">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link <?= $active_tab === 'appearance' ? 'active bg-white text-primary' : 'text-white' ?>" 
                       href="test%20copy.php?tab=appearance" role="tab">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link <?= $active_tab === 'notifications' ? 'active bg-white text-primary' : 'text-white' ?>" 
                       href="test%20copy.php?tab=notifications" role="tab">
						...
						<div class="p-4">
							<div class="card border-0 shadow-sm mb-4">
								<div class="card-header bg-success text-white d-flex justify-content-between align-items-center py-3">
									...
									<a href="test%20copy.php?tab=features" class="btn btn-light btn-sm">
								...
								<div class="card-body">
									<form method="post" class="row g-4 needs-validation" novalidate>
										...
										<div class="col-12 text-end">
											<a href="test%20copy.php?tab=features" class="btn btn-outline-secondary btn-modern me-2">
											...
											<div class="card h-100 settings-card">
												...
												<div class="card-body">
													...
													<div class="d-flex justify-content-center gap-2 mt-4">
														<a href="test%20copy.php?tab=features&action=edit_feature&code=<?= $view_feature['feature_id'] ?>" class="btn btn-primary btn-modern">
															<i class="fas fa-edit me-2"></i>Edit Feature
														</a>
														<?php if($view_feature['feature_status'] == 'Enable'): ?>
															<a href="test%20copy.php?tab=features&action=toggle_feature&status=Disable&code=<?= $view_feature['feature_id'] ?>" 
														...
														<?php else: ?>
															<a href="test%20copy.php?tab=features&action=toggle_feature&status=Enable&code=<?= $view_feature['feature_id'] ?>" 
						...
						<div class="p-4">
							<div class="row mb-4">
								...
								<div class="col-md-6 text-md-end">
									<a href="test%20copy.php?tab=features&action=add_feature" class="btn btn-success btn-modern">
														...
														<tr>
															...
															<td>
																<div class="btn-group" role="group">
																	<a href="test%20copy.php?tab=features&action=view_feature&code=<?= $feature['feature_id'] ?>" class="btn btn-info btn-sm" data-bs-toggle="tooltip" title="View Details">
																		<i class="fas fa-eye"></i>
																	</a>
																	<a href="test%20copy.php?tab=features&action=edit_feature&code=<?= $feature['feature_id'] ?>" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" title="Edit Feature">
																		<i class="fas fa-edit"></i>
																	</a>
																	<?php if($feature['feature_status'] == 'Enable'): ?>
																		<a href="test%20copy.php?tab=features&action=toggle_feature&status=Disable&code=<?= $feature['feature_id'] ?>" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" title="Disable">
																			<i class="fas fa-times-circle"></i>
																		</a>
																	<?php else: ?>
																		<a href="test%20copy.php?tab=features&action=toggle_feature&status=Enable&code=<?= $feature['feature_id'] ?>" class="btn btn-success btn-sm" data-bs-toggle="tooltip" title="Enable">
													...
													<tr>
														<td colspan="7" class="text-center py-4">
															<div class="d-flex flex-column align-items-center">
																...
																<a href="test%20copy.php?tab=features&action=add_feature" class="btn btn-success btn-sm">
																	<i class="fas fa-plus-circle me-2"></i>Add New Feature
																</a>
															</div>
														</td>
   	...
   	$(document).ready(function() {
		$('#dataTable').DataTable({
			...
			columnDefs: [
				...
				{ responsivePriority: 2, targets: 6 },  // Actions (index 6 = 7th column)
				...
				{ 
					targets: [2, 3, 4], // Icon, Color, Position
