...
<div class="container-fluid px-4">
    ...
    <?php if (isset($_GET['action']) && $_GET['action'] === 'edit' && isset($_GET['code'])): ?>   
        <?php
            ...
            // Get detailed book information including image
            if ($issue) {
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-gradient-primary text-white py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold"><i class="fas fa-book-reader me-2"></i>Process Book Return</h5>
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 border-0 shadow-sm">
                                    ...
                                    <div class="card-body text-center">
                                        <?php if (isset($book_details) && !empty($book_details['book_img'])): ?>
                                            <img src="<?= htmlspecialchars(getBookImagePath($book_details['book_img'])) ?>" 
                                                alt="<?= htmlspecialchars($book_details['book_name']) ?>" 
                                                class="img-fluid mb-3 rounded shadow-sm" style="max-height: 200px;">
                                        <?php else: ?>
                                            <div class="bg-light p-4 mb-3 rounded">
                                                <i class="fas fa-book fa-4x text-secondary"></i>
                                                <p class="mt-2 text-muted small">No image available</p>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="mt-3 text-start">
                                            <?php if (!empty($book_details['isbn_number'])): ?>
                                            <p class="mb-1 small">
                                                <span class="fw-bold text-muted">ISBN:</span> 
                                                <?= htmlspecialchars($book_details['isbn_number']) ?>
                                            </p>
                                            <?php endif; ?>
                                            
                                            <?php if (!empty($book_details['category_name'])): ?>
                                            <p class="mb-1 small">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3" id="damageNotesContainer" style="display: none;">
                                                        ...
                                                        <textarea name="damage_notes" class="form-control" rows="2" placeholder="Please describe the damage..."></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <!-- Script to show/hide damage notes based on condition -->
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function toggleDamageNotes() {
                    ...
                    if (condition !== 'Good') {
                        damageNotesContainer.style.display = 'block';
                    } else {
                        damageNotesContainer.style.display = 'none';
                    }
                }
                
                conditionSelect.addEventListener('change', toggleDamageNotes);
                toggleDamageNotes(); // Run on page load
            });
        </script>
        ...
        <?php
                ...
                echo '<div class="alert alert-danger shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1">Record Not Found</h5>
                                <p class="mb-0">The returned book record you are looking for does not exist.</p>
                            </div>
                        </div>
                        <div class="mt-3">
                            <a href="return_book.php" class="btn btn-outline-secondary">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card shadow-sm border-0 mb-4">
                            <div class="card-header bg-gradient-primary text-white py-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="mb-0 fw-bold"><i class="fas fa-book-reader me-2"></i>Return Book Details</h5>
                                    <a href="return_book.php" class="btn btn-sm btn-light">
                                        <i class="fas fa-arrow-left me-1"></i>Back to List
                                    </a>
                                </div>
