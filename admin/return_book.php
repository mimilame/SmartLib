        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white py-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="return_book.php" class="btn btn-sm btn-outline-secondary">
        ...
        <?php
            ...
            <?php else: ?>
                <div class="alert alert-danger" role="alert">
                    ...
                    <a href="return_book.php" class="btn btn-sm btn-outline-secondary ms-3">Back to Return Books</a>
                </div>
            <?php endif; ?>
