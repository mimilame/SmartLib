            ...
            <div class="card-body">
                            ...
                            foreach ($statement->fetchAll() as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger btn-sm" onclick="delete_data(\'' . $row["category_id"] . '\', \'' . $row["category_status"] . '\')"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>';
                            }
                        } else {
                ...
                <script>
                    function delete_data(code, status) {
                        ...
                        const message = `Are you sure you want to ${new_status} this Category?`;
