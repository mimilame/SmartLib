...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 12, 2025 at 02:50 AM
...
CREATE TABLE IF NOT EXISTS `lms_admin` (
  ...
  `admin_password` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
...
(1, 1, 'Lynn Beighley, Daginn Reiersol', 'A1', 'The Joy of PHP Programming', '978152279214', 6, 'Enable', 'book_placeholder.png', '2021-11-11 09:32:33', '2025-04-01 07:06:47'),
(2, 1, 'Tom Butler', 'A2', 'PHP and MySQL Novice to Ninja', '852369852123', 6, 'Enable', 'book_placeholder.png', '2021-11-12 04:56:23', '2025-04-01 06:51:01'),
(3, 1, 'Cate Blanchett, Vikram Vaswani', 'A3', 'Head First PHP and MySQL', '7539518526963', 5, 'Enable', 'book_placeholder.png', '2021-11-12 04:57:04', '2025-03-31 09:54:55'),
(4, 1, 'Tom Butler', 'A4', 'PHP A Beginners Guide', '74114774147', 5, 'Enable', 'book_placeholder.png', '2021-11-12 04:57:47', '2025-03-31 09:54:55'),
(5, 1, 'Lynn Beighley, Daginn Reiersol', 'A5', 'PHP In Action Objects Design Agility', '85225885258', 5, 'Enable', 'book_placeholder.png', '2021-11-12 04:58:34', '2025-03-31 09:54:55'),
(6, 1, 'Cate Blanchett, Tom Butler, Vikram Vaswani', 'A6', 'Murachs PHP and MySQL', '8585858596632', 5, 'Enable', 'book_placeholder.png', '2021-11-12 05:00:15', '2025-03-31 09:54:55'),
(7, 1, 'Lynn Beighley', 'A8', 'Learning PHP MySQL JavaScript and CSS Creating Dynamic Websites', '753852963258', 5, 'Enable', 'book_placeholder.png', '2021-11-12 05:01:10', '2025-03-31 09:54:55'),
(8, 1, 'Cate Blanchett, Daginn Reiersol', 'A10', 'Programming PHP Creating Dynamic Web Pages', '969335785842', 5, 'Enable', 'book_placeholder.png', '2021-11-12 05:01:57', '2025-03-31 09:54:55'),
(9, 1, 'Tom Butler, Vikram Vaswani', 'A1', 'PHP Programming and MySQL Database for Web Development', '963369852258', 5, 'Enable', 'book_placeholder.png', '2021-11-12 05:02:48', '2025-03-31 09:54:55'),
(10, 1, 'Cate Blanchett, Lynn Beighley, Daginn Reiersol', 'A2', 'PHP MySQL The Missing Manual', '85478569856', 5, 'Enable', 'book_placeholder.png', '2021-11-12 05:03:51', '2025-03-31 09:54:55'),
(11, 1, 'Joel Murach, Sanjib Sinha', 'A3', 'Beginning Laravel A beginners guide', '856325774562', 5, 'Enable', 'book_placeholder.png', '2021-11-12 05:04:39', '2025-03-31 09:54:55'),
(12, 1, 'Robin Nixon, Brian Messenlehner', 'A3', 'Building Web Apps with WordPress', '96325741258', 5, 'Enable', 'book_placeholder.png', '2021-11-12 05:05:18', '2025-03-31 09:54:55'),
...
(19, 6, 'Bruce Berke', '10', 'Rizal 101', '09844888484', 5, 'Enable', 'book_placeholder.png', '2025-03-30 15:53:25', '2025-04-12 02:50:42');
...
DELIMITER $$
CREATE TRIGGER `after_book_insert` AFTER INSERT ON `lms_book` FOR EACH ROW BEGIN
    -- When a new book is added, create empty placeholder entries for all active users
    -- These entries will be updated when users submit actual ratings
    INSERT INTO lms_book_review (book_id, user_id, rating, review_text, created_at, updated_at)
    SELECT 
        NEW.book_id,
        user_id,
        NULL, -- Default rating is NULL until user submits a rating
        NULL, -- Default review text is NULL until user submits a review
...
(2, 16, 21, '2025-04-03', '2025-04-11', 8, 40, 'Unpaid', '2025-04-01 07:08:42', '2025-04-01 07:08:42');
...
INSERT INTO `lms_issue_book` (`issue_book_id`, `book_id`, `user_id`, `issue_date`, `expected_return_date`, `return_date`, `issue_book_status`, `issued_on`, `issue_updated_on`) VALUES
(9, 1, 3, '2021-12-28', '2022-01-07', '2022-01-03', 'Returned', '2025-03-30 06:00:16', '2025-03-30 07:54:41'),
(10, 2, 4, '2025-03-14', '2025-03-24', '2025-03-14', 'Returned', '2025-03-30 06:00:16', '2025-03-30 07:54:53'),
...
(16, 2, 6, '2025-03-14', '2025-04-03', '2025-03-26', 'Returned', '2025-03-30 05:38:05', '2025-04-01 04:21:01'),
(17, 2, 11, '2025-03-31', '2025-04-02', '2025-04-08', 'Lost', '2025-03-30 05:50:28', '2025-03-30 05:52:25'),
(18, 19, 17, '2025-03-31', '2025-04-02', NULL, 'Lost', '2025-03-30 05:54:59', '2025-03-30 08:38:53'),
...
CREATE TABLE IF NOT EXISTS `lms_librarian` (
  ...
  `librarian_password` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
(8, 'Steffi Wong', NULL, '092773782882', NULL, 'wong@gmail.com', '$2y$10$rjBqnSr3YC9C/qUOPWMVXeaD5ODxZxwIV3QG.Fbf5Ot3IODv69Cru', 2, NULL, NULL, NULL, 'Enable', '2025-03-20 08:54:00', '2025-03-31 15:33:13'),
(9, 'sample', NULL, '09546213578', NULL, 'sample.test@gmail.com', '$2y$10$rjBqnSr3YC9C/qUOPWMVXeaD5ODxZxwIV3QG.Fbf5Ot3IODv69Cru', 2, NULL, NULL, 'L52907001', 'Enable', '2025-03-26 21:25:17', '2025-03-31 15:33:13');
...
(11, 'Faye Lacsi', '', '09823830938478', 'user.jpg', 'lacsi@gmail.com', '$2y$10$rjBqnSr3YC9C/qUOPWMVXeaD5ODxZxwIV3QG.Fbf5Ot3IODv69Cru', 5, '', 'No', 'U17845470', 'Enable', '2025-03-20 10:10:18', '2025-03-31 15:33:13'),
(12, 'Jake Bruce', '', '09736788383', 'user.jpg', 'bruce@gmail.com', '$2y$10$rjBqnSr3YC9C/qUOPWMVXeaD5ODxZxwIV3QG.Fbf5Ot3IODv69Cru', 5, '', '', 'U41683769', 'Enable', '2025-03-20 06:02:39', '2025-03-31 15:33:13'),
...
(15, 'Kate Pink', '', '0973787366', 'user.jpg', 'pink@gmail.com', '$2y$10$rjBqnSr3YC9C/qUOPWMVXeaD5ODxZxwIV3QG.Fbf5Ot3IODv69Cru', 5, '', 'No', 'U82157096', 'Enable', '2025-03-20 10:41:02', '2025-03-31 15:33:13'),
