...
CREATE TABLE IF NOT EXISTS `lms_admin` (
  ...
  `admin_email` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `admin_password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `admin_unique_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `role_id` int NOT NULL DEFAULT '1',
  `admin_profile` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'admin.jpg',
...
CREATE TABLE IF NOT EXISTS `lms_author` (
  ...
  `author_status` enum('Enable','Disable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `author_profile` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'author.jpg',
  `author_biography` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(21, 'Yung Kai', 'Enable', 'author_1744434830.jpg', 'Yung Kai is known for his sharp wit and ability to transform everyday experiences into memorable tales.', '2025-04-12 02:43:50', '2025-04-22 05:31:45');
...
CREATE TABLE IF NOT EXISTS `lms_book` (
  ...
  `book_author` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `book_location_rack` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `book_name` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `book_isbn_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `book_no_of_copy` int NOT NULL,
  `book_status` enum('Enable','Disable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `book_img` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'book_placeholder.png',
  `book_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `book_edition` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 1, 'Lynn Beighley, Daginn Reiersol', 'A1', 'The Joy of PHP Programming', '978152279214', 8, 'Enable', '67fce6b003e4c.png', '', '1st Edition', 'Maglaya Publishing.Co', '2024-07-16', '2021-11-11 09:32:33', '2025-05-06 08:21:52'),
(2, 1, 'Tom Butler', 'A2', 'PHP and MySQL Novice to Ninja', '852369852123', 11, 'Enable', 'book_placeholder.png', '', '', '', '0000-00-00', '2021-11-12 04:56:23', '2025-04-22 07:02:12'),
(3, 1, 'Cate Blanchett, Vikram Vaswani', 'A3', 'Head First PHP and MySQL', '7539518526963', 6, 'Enable', 'book_placeholder.png', NULL, NULL, NULL, NULL, '2021-11-12 04:57:04', '2025-05-04 07:39:47'),
...
(5, 1, 'Lynn Beighley, Daginn Reiersol', 'A5', 'PHP In Action Objects Design Agility', '85225885258', 6, 'Enable', 'book_placeholder.png', NULL, NULL, NULL, NULL, '2021-11-12 04:58:34', '2025-05-06 10:50:28'),
...
(17, 1, 'Mark Myers', 'A11', 'A Smarter Way to Learn JavaScript', '852369753951', 3, 'Enable', 'book_placeholder.png', NULL, NULL, NULL, NULL, '2021-12-08 10:48:11', '2025-05-06 08:15:55'),
(18, 1, 'Carlos Buenosvinos, Rose', 'A3', 'Happy', '64739929873', 9, 'Enable', 'book_placeholder.png', NULL, NULL, NULL, NULL, '2025-03-14 12:57:42', '2025-05-06 12:30:55'),
(19, 6, 'Bruce Berke', 'A10', 'Rizal 101', '09844888484', 6, 'Enable', 'book_placeholder.png', '', '', '', '0000-00-00', '2025-03-30 15:53:25', '2025-04-23 05:57:08'),
...
(23, 6, 'Brian Messenlehner, Carlos Buenosvinos', 'A1', 'Test', '25648495498', 0, 'Enable', '6806f1c026574.jpg', '', '1st Edition', 'Maglaya Publishing.Co', '2025-04-22', '2025-04-21 03:27:54', '2025-05-04 09:08:26'),
(24, 9, 'Daginn Reiersol, Bruce Berke', 'A3', 'Lucky Me', '34353553', 1, 'Enable', 'book_placeholder.png', '', '', '', '2025-04-23', '2025-04-22 07:02:50', '2025-05-04 09:11:08');
...
CREATE TABLE IF NOT EXISTS `lms_book_review` (
  ...
  `review_text` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `flagged_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `lms_category` (
  ...
  `category_status` enum('Enable','Disable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_created_on` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_updated_on` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Programming', 'Enable', '2021-11-10 19:02:37', '2025-05-05 21:43:52'),
...
(10, 'Thesis Study', 'Enable', '2025-04-22 13:27:01', '2025-04-22 13:27:01');
...
CREATE TABLE IF NOT EXISTS `lms_fines` (
  ...
  `fines_status` enum('Paid','Unpaid') COLLATE utf8mb4_unicode_ci NOT NULL,
...
(50, 4, 17, '2025-05-02 16:19:17', '0000-00-00 00:00:00', 4, 20, 'Paid', '2025-05-06 08:19:52', '2025-05-06 21:29:22'),
(51, 6, 18, '2025-05-09 17:00:00', '0000-00-00 00:00:00', 0, 200, 'Unpaid', '2025-05-06 08:21:23', '2025-05-06 11:31:14'),
(52, 5, 19, '2025-05-04 00:00:00', '2025-05-07 00:00:00', 2, 0, 'Unpaid', '2025-05-06 08:25:48', '2025-05-06 11:32:41'),
(53, 4, 20, '2025-05-03 20:29:48', '0000-00-00 00:00:00', 2, 10, 'Unpaid', '2025-05-06 12:30:36', '2025-05-06 21:29:18');
...
CREATE TABLE IF NOT EXISTS `lms_issue_book` (
  ...
  `expected_return_date` datetime NOT NULL,
  `return_date` datetime NOT NULL,
  `issue_book_status` enum('Issued','Returned','Overdue','Lost') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `book_condition` enum('Good','Damaged','Missing Pages','Water Damaged','Binding Loose') COLLATE utf8mb4_unicode_ci NOT NULL,
...
(17, 1, 4, '2025-05-01 00:00:00', '2025-05-02 00:00:00', '2025-05-06 00:00:00', 'Returned', '2025-05-06 08:19:48', '2025-05-06 20:19:32', 'Good', NULL),
(18, 18, 6, '2025-05-06 00:00:00', '2025-05-09 17:00:00', '0000-00-00 00:00:00', 'Lost', '2025-05-06 08:21:01', '2025-05-06 08:21:01', 'Good', NULL),
(19, 5, 5, '2025-05-01 00:00:00', '2025-05-04 00:00:00', '2025-05-07 00:00:00', 'Returned', '2025-05-06 08:25:45', '2025-05-06 10:50:28', 'Damaged', NULL),
(20, 5, 4, '2025-05-01 20:29:48', '2025-05-03 20:29:48', '0000-00-00 00:00:00', 'Overdue', '2025-05-06 12:30:30', '2025-05-06 20:19:42', '', NULL),
(21, 18, 16, '2025-05-06 00:00:00', '2025-05-09 17:00:00', '0000-00-00 00:00:00', 'Issued', '2025-05-06 12:30:55', '2025-05-06 12:30:55', 'Good', NULL);
...
CREATE TABLE IF NOT EXISTS `lms_librarian` (
  ...
  `librarian_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `librarian_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `librarian_contact_no` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `librarian_profile` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'librarian.jpg',
  `librarian_email` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `librarian_password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `role_id` int NOT NULL DEFAULT '2',
  `librarian_verification_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `librarian_verification_status` enum('No','Yes') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `librarian_unique_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `librarian_status` enum('Enable','Disable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Honey A. Atilano', 'Curuan, Zamboanga City', '093784757387', 'admin_1745383657.jpg', 'honey@gmail.com', '$2y$10$CpNhIhY4I0cwqbtli3dArumSmOVy18nUQ8Ryo9gdgrFUPF0LVnPTC', 2, NULL, 'Yes', 'L12345678', 'Enable', '2025-03-20 10:22:31', '2025-04-22 20:47:37'),
...
(10, 'Lady Gaga', NULL, '095484656565', '1744623562_Screenshot 2025-03-28 095301.png', 'ladygaga@gmail.com', '$2y$10$QFIsrTQrzD90gjUpHcuCdOQBkRh2eo0lB8nH9iHcwvXWsmmtH5SSK', 2, NULL, NULL, 'L25235740', 'Enable', '2025-04-12 06:47:29', '2025-05-05 13:51:01');
...
CREATE TABLE IF NOT EXISTS `lms_library_features` (
  ...
  `feature_icon` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `feature_status` enum('Enable','Disable') COLLATE utf8mb4_unicode_ci DEFAULT 'Enable',
...
CREATE TABLE IF NOT EXISTS `lms_location_rack` (
  ...
  `location_rack_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `location_rack_status` enum('Enable','Disable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'A1', 'Enable', '2021-11-11 08:16:27', '2025-04-22 07:01:05', 60, 80),
...
CREATE TABLE IF NOT EXISTS `lms_setting` (
  `setting_id` int NOT NULL AUTO_INCREMENT,
  `library_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `library_address` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `library_contact_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `library_email_address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `library_open_hours` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '8am-4pm MON-FRI',
  ...
  `library_currency` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `library_timezone` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `library_logo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'logo.png',
  PRIMARY KEY (`setting_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'WMSU', 'Curuan, Zamboanga City', '097988438', 'rodrigotarro694@gmail.com', '{\"Monday\":{\"open\":\"08:00\",\"close\":\"17:00\"},\"Tuesday\":{\"open\":\"08:00\",\"close\":\"17:00\"},\"Wednesday\":{\"open\":\"08:00\",\"close\":\"17:00\"},\"Thursday\":{\"open\":\"08:00\",\"close\":\"17:00\"},\"Friday\":{\"open\":\"08:00\",\"close\":\"17:00\"},\"Saturday\":{\"open\":null,\"close\":null},', 3, 5.00, 50.00, 3, 'PHP', 'Asia/Manila', 'logo.png');
...
CREATE TABLE IF NOT EXISTS `lms_user` (
  ...
  `user_address` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_contact_no` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_profile` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user.jpg',
  ...
  `user_verification_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_verification_status` enum('No','Yes') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_unique_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_status` enum('Enable','Disable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
